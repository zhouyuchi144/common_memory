...
def main(current_date):
    ...
    file_ride_param = f"hdfs://localhost:9000/data/ride_parameters/partition_date={current_date}/"
    file_ride_order = f"hdfs://localhost:9000/data/ride_hailing_order/partition_date={current_date}/"
    file_dw_ride = f"hdfs://localhost:9000/data/dw_ride_di/partition_date={current_date}/"
